...
export default function ModelPortfolioDetail({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 pt-4 pb-safe">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-3xl max-h-modal flex flex-col overflow-hidden bg-[#FEFEFE] rounded-2xl shadow-[0_8px_32px_rgba(45,52,54,0.12)] border border-[#E8E8E6]">
        {/* Header */}
